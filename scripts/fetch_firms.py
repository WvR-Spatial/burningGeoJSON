...
def summarise_clusters(points, labels, window_dates):
    ...
    features.sort(key=lambda f: -f["properties"]["frp_total"])
    return features
...
def main():
    ...
    clusters = summarise_clusters(all_points, labels, window)
    ...
    meta = {
        ...
        "params": {"eps_km": EPS_KM, "min_pts": MIN_PTS, "window_days": WINDOW_DAYS},
        "counts": {
